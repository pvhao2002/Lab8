...
public class SaveTestNGResultToExcel {
	...
	// định nghĩa 1 excel work book
	HSSFWorkbook workbook;
	// định nghĩa 1 excel work sheet
	HSSFSheet worksheet; 
	...
	public void LaunchWebsite() throws Exception {
		try {
			...
			TestNGResults.put("2", new Object[] { 1d, "Navigate demo website", "Site gets opened", "Pass" });
		} catch (Exception e) {
...
//			WebElement password = driver.findElement(By.name("password"));
			...
			TestNGResults.put("3", new Object[] { 2d, "Fill Login form data (Username/Password)",
					"Login details gets Filled", "Failed" });
			AssertJUnit.assertTrue(false);
		}
	}
...
//			login.click();		
			...
			Thread.sleep(1000);
			TestNGResults.put("4",
					new Object[] { 3d, "Click Login and verify welcome massage", "Login success", "Pass" });
		} catch (Exception e) {
			e.printStackTrace();
			TestNGResults.put("4",
					new Object[] { 3d, "Click Login and verify welcome massage", "Login success", "Failed" });
	...
	public void suiteSetup() {
		...
		try {
			...
			// lấy địa chỉ file object
			uimap = new UIMap(workingDir + "\\Resources\\locator.properties");

			// cài đặt địa chỉ Chrome Driver
