...
public class TestLogin {
	...
	public void suiteTearDown() {
		...
		for (String key : keyset) {
			...
			try {
				FileOutputStream out = new FileOutputStream(new File(EXCEL_DIR + "RESULTt_LOGIN.xlsx"));
				workbook.write(out);
				out.close();
	...
	public void LoginTest() {
		try {
			...
			for (String key : keySet) {
				...
				driver.get("http://localhost:8080/asignment2/login");
				driver.findElement(By.xpath("/html/body/div/div/div/form/div[2]/input"))
						.sendKeys(username);
				driver.findElement(By.xpath("/html/body/div/div/div/form/div[3]/input"))
						.sendKeys(password);

				Thread.sleep(1000);

				WebElement btnLogin = driver
						.findElement(By.xpath("/html/body/div/div/div/form/div[6]/button"));
				...
				if (actualTitle.equalsIgnoreCase(expected)) {					
					TestNGResult.put(String.valueOf(index + 1), new Object[] { String.valueOf(index),
							username,
							password,
							"Test Login", 
							expected,
					...
					driver.findElement(By.xpath("/html/body/div/div/div/form/div[2]/input")).sendKeys(username);
					driver.findElement(By.xpath("/html/body/div/div/div/form/div[3]/input")).sendKeys(password);
